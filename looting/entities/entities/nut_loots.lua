...
if (SERVER) then
	...
	function ENT:Initialize()
		...
		self:setNetVar("delTime", CurTime() + nut.config.get("lootTime"))
		
		timer.Simple(nut.config.get("lootTime"), function()
	...
	function ENT:Draw()
		...
		local func = function() 
			...
			drawText("k", 0, 0, assColor, 1, 4, "nutIconsBig")
			drawText(delTime, 0, -10, assColor, 1, 5, "nutBigFont")
		end
